...
template <class DerivedType>
typename DerivedType::DType Sum(const DownCast<DerivedType> &A)
{
    typename DerivedType::DType sum = 0.0;
...
template <class DerivedType>
typename DerivedType::DType Mean(const DownCast<DerivedType> &A)
{
    typename DerivedType::DType sum = Sum(A);

    typename DerivedType::DType mean = sum / (DerivedType::Rows * DerivedType::Cols);
