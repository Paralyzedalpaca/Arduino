...
class ExtendedKalman {
    public:
        // Constructors
        ExtendedKalman();
        ExtendedKalman(Matrix<2,2> Q, Matrix<3,3> R, float f_acc, float f_gyr, float *ax_filt, float *ay_filt, float *az_filt, float *gx_filt, float *gy_filt, float *gz_filt, float *roll, float *pitch, float *yaw_rate);
